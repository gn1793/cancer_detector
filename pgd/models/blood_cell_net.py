...
from pgd.models.components.attention import SelfAttention

# 상대 경로로 데이터셋 경로 설정
BASE_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'datasets')
